/**
 * Custom Week View Template
 * Displays events for the next 7 days, grouped by day
 * 
 * This is a sample custom template based on the built-in week-view.
 * Feel free to modify the CONFIG section below to customize colors, fonts, and layout!
 * 
...
// ============================================================================
module.exports = function customWeekView(data) {
