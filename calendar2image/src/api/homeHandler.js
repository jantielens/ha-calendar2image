    ...
    return `
      <tr>
        ...
        <td class="links-col">
          ...
          <a href="${timelineUrl}" class="link-btn timeline-btn" style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:white;" title="View event timeline (24h)">Timeline</a>
